...
## Logic
- [ ] Refactor sourcing / scraping for modularity and security (with possible distribution in mind)
- [ ] Onboarding questions not optimal, also tedious to fill out. Maybe pick questions / answers

## Ideas
- Data sources and more / better / safer scraping
...
- Reminder system for applied listings
- full pipeline from searching to apply overview, reminders and more
- Webhosting and general end-user usability
...
Self-hosted job application tool. Raspberry Pi, SQLite, AGPL-3.0. Little Users. Built for your own use; not laymen-ready.
